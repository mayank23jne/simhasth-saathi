            ...
            <div className=" mx-auto inline-block mb-4">
              ...
              >
                <svg viewBox="0 0 24 24" className="h-14 w-14 drop-shadow-lg" aria-label="Simhasth Logo in Shield">
                  <defs>
                    <pattern id="logo-pattern" patternUnits="objectBoundingBox" width="1" height="1">
                      <image xlinkHref={simhasthaLogo} x="0" y="0" width="24" height="24" preserveAspectRatio="xMidYMid slice" />
                    </pattern>
                  </defs>
                  <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" fill="url(#logo-pattern)" />
